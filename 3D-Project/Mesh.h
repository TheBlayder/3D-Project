...
public:
	Mesh() = default;
	Mesh(ID3D11Device* device, const std::string& folderPath, const std::string& objectName, const std::string& textureFolder = "", const bool flipUVy = true);
	~Mesh() = default;
	...
	void Init(ID3D11Device* device, const std::string& folderPath, const std::string& objectName, const std::string& textureFolder = "", const bool flipUVy = true);
